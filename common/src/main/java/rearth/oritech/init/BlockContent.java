...
public class BlockContent implements ArchitecturyBlockRegistryContainer {
    ...
    // tier 2 addon
    @ItemContent.ItemGroupTarget(ItemContent.Groups.addons)
    public static final Block MACHINE_SPEED_ADDON_TIER_2 = new MachineAddonBlock(AbstractBlock.Settings.copy(Blocks.IRON_BLOCK).nonOpaque(), AddonSettings.getDefaultSettings().withSpeedMultiplier(0.79f).withEfficiencyMultiplier(1.10f).withBoundingShape(MachineAddonBlock.MACHINE_SPEED_ADDON_SHAPE).withTier(2));
    @ItemContent.ItemGroupTarget(ItemContent.Groups.addons)
    public static final Block MACHINE_EFFICIENCY_ADDON_TIER_2 = new MachineAddonBlock(AbstractBlock.Settings.copy(Blocks.IRON_BLOCK).nonOpaque(), AddonSettings.getDefaultSettings().withEfficiencyMultiplier(0.79f).withBoundingShape(MachineAddonBlock.MACHINE_EFFICIENCY_ADDON_SHAPE).withTier(2));
